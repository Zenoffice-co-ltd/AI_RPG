...
function buildAgentPrompt(input: {
  ...
  return [
    ...
    "**短い相槌 (『うん』『はい』『えっと』『そうですね』 単独) を identity_self / overview_shallow の質問と誤判定しない (manual orb v7 P1 fix)**: 学習者の単発の相槌は『曖昧な発話』として扱い、最大 1 度の『ご確認したい点からで大丈夫です。』程度に留めるか、何も返さず次の発話を待ちます。役職や会社情報を再度言い直しません。",
