...
export const STAFFING_ADECCO_DISCLOSURE_LEDGER: DisclosureItem[] = [
  {
    ...
    intentDescription:
      "学習者が **明示的に** 役割や立場を確認した時 **だけ**。例：『あなたは誰ですか』『どなたですか』『役職は』『お名前は』『どちら様ですか』。**短い相槌『うん』『はい』『えっと』『そうですね』『なるほど』『あ、』単独 では identity_self を発火させない (manual orb v7 P1 fix)** — それらは曖昧発話として扱い、何も返さず次の発話を待つ。役職を 2 回以上同じ会話で言い直さない。",
    allowedAnswer:
