...
export const STAFFING_ADECCO_DISCLOSURE_LEDGER: DisclosureItem[] = [
  ...
  },
  {
    ...
    intentDescription:
      "学習者が Adecco に先行提案期間を求めた時。『先行して提案する期間をもらえるか』『初回提案期間』『先に候補を出す時間』。",
    allowedAnswer:
  ...
  },
  {
    ...
    negativeExamples: [
      "整理ありがとうございます。それでは、Adeccoさんの派遣の特徴や強み、他社との違いはどこですか。",
    ],
    asrVariantTriggers: [
      "誰が決める",
      "決定",
  ...
  },
  {
    ...
    intentDescription: [
      "学習者が商談終盤の要約をした時。以下のいずれかを満たしたら closing_summary として扱う：",
      "(a) 学習者が複数条件（人数・開始日・就業時間・残業・単価・優先経験・次回提案・連絡方法 のうち三項目以上）を一つの発話でまとめて確認している",
      "(b) 発話に『整理させてください』『まとめると』『この進め方でよろしいでしょうか』『という理解で』『確認ですが』のいずれかが含まれる",
      "(c) chat_history 上で会話終盤の summary ターンとして与えられている",
      "(d) 提案候補の数や提出期限がセットで言及されている",
      "上記いずれかに該当したら必ず closing_summary として処理し、要約への合意/修正コメント → Adecco の強み・違いの逆質問を一度だけ、の順で返す。",
    ].join("\n  "),
    allowedAnswer:
      "要約に合意し、誤りがあれば修正する。必要な補足を述べた後に一度だけ Adecco の強み・他社との違いを逆質問する。例：「はい、大きくはその整理で合っています。補足すると、受発注経験と対外調整の経験を特に重視したいです。ちなみに、Adeccoさんの派遣の特徴や、他社さんとの違いはどのあたりでしょうか。」",
    forbiddenUntilAsked: [],
    negativeExamples: [
