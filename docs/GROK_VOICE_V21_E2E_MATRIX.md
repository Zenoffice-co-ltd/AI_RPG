...
| `case27_busy_period_only_no_volume_leak` | 繁忙時期質問では件数を漏らさない | yes | 繁忙時期 | 時期だけ答え、件数は出さない | 月のおわり, 月の初め, 月曜日, 商品切替 | 月末, 月初, 六百, 七百, 件, stock suffix | 2 | over-disclosure by intent | PR60 manual voice feedback |
...
| `case35_rate_voice_friendly_pronunciation` | 請求単価は漢数字の円レンジで安定して読み上げる | yes | 請求単価もう一回 | 円レンジをTTS安定表記で一文回答 | 千七百五十円, 千九百円, 程度 | せんななひゃくごじゅう, せんきゅうひゃく, stock suffix | 1 | rate pronunciation | PR61/manual voice feedback, 2026-05-07 revision |
...
| `case37_personality_no_jikoryu_pronunciation` | 自己流は自分のやり方として読み上げる | yes | 人柄 | 人柄をTTS安定表記で短く答える | 自分のやり方, 周囲と合わせて進められるタイプ | 自己流, 協調型, stock suffix | 2 | personality pronunciation | PR61/manual voice feedback, 2026-05-07 revision |
