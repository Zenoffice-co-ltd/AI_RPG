...
gcloud run deploy roleplay-ui \
  ...
  --set-env-vars ELEVENLABS_AGENT_ID=agent_2801kpj49tj1f43sr840cvy17zcc,ELEVENLABS_BRANCH_ID=agtbrch_9701kpj49vbdepjr8szvwc6w7e6b,ELEVENLABS_ENVIRONMENT=production,ELEVENLABS_VOICE_PROFILE_ID=staffing_order_hearing_adecco_manufacturer_ja_v3_candidate_v2,NEXT_PUBLIC_APP_NAME="AI Roleplay",NEXT_PUBLIC_DEFAULT_SCENARIO_ID=adecco-orb \
