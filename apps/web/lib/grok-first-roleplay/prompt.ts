...
import {
  GROK_FIRST_V50_2_FIRST_MESSAGE,
  GROK_FIRST_V50_2_SYSTEM_PROMPT,
} from "./prompt-v50-2";
import {
  GROK_FIRST_V50_3_FIRST_MESSAGE,
  GROK_FIRST_V50_3_SYSTEM_PROMPT,
} from "./prompt-v50-3";
import {
...
export const GROK_FIRST_V50_2_SCENARIO_ID =
  "staffing_order_hearing_adecco_manufacturer_busy_manager_medium_v50_2";
export const GROK_FIRST_V50_3_SCENARIO_ID =
...
export function buildGrokFirstV50Prompt(
  ...
  if (variant === "v50.2") {
    return buildPrompt({
      instructions: GROK_FIRST_V50_2_SYSTEM_PROMPT,
      promptVersion: GROK_FIRST_V50_2_PROMPT_VERSION,
      scenarioId: GROK_FIRST_V50_2_SCENARIO_ID,
      firstMessage: GROK_FIRST_V50_2_FIRST_MESSAGE,
    });
  }
  if (variant === "v50.3") {
    return buildPrompt({
      instructions: GROK_FIRST_V50_3_SYSTEM_PROMPT,
      promptVersion: GROK_FIRST_V50_3_PROMPT_VERSION,
      scenarioId: GROK_FIRST_V50_3_SCENARIO_ID,
      firstMessage: GROK_FIRST_V50_3_FIRST_MESSAGE,
    });
  }
  if (variant === "v50.5") {
    return buildPrompt({
