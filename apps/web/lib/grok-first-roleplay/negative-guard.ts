...
const FORBIDDEN_SUFFIX_PATTERNS: RegExp[] = [
  ...
  /(何か|なにか).*(確認|補足).*(したい|しておきたい).*(ところ|点).*(ありますか|ございますか|でしょうか|ですか)[？?。]*$/u,
  /(お聞きになりたい|聞きたい|知りたい).*(ところ|点|部分).*(ありますか|ございますか|でしょうか|ですか)[？?。]*$/u,
...
const GENERIC_CLOSING_QUESTION_PATTERNS: RegExp[] = [
  ...
  /気になる点はありますか/u,
  /確認しておきたい点はありますか/u,
  /確認しておきたい(ところ|点).*(ありますか|ございますか|でしょうか|ですか)/u,
  /お聞きになりたい(ところ|点).*(ありますか|ございますか|でしょうか|ですか)/u,
