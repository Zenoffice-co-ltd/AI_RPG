...
export const GROK_FIRST_V50_2_DEMO_SLUG = "adecco-roleplay-v50-2" as const;
export const GROK_FIRST_V50_3_DEMO_SLUG = "adecco-roleplay-v50-3" as const;
...
export const GROK_FIRST_V50_2_BACKEND = "grok-first-v50-2" as const;
export const GROK_FIRST_V50_3_BACKEND = "grok-first-v50-3" as const;
...
export type GrokFirstDemoSlug =
  ...
  | typeof GROK_FIRST_V50_2_DEMO_SLUG
  | typeof GROK_FIRST_V50_3_DEMO_SLUG
...
export type GrokFirstBackend =
  ...
  | typeof GROK_FIRST_V50_2_BACKEND
  | typeof GROK_FIRST_V50_3_BACKEND
