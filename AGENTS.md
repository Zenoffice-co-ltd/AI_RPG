...
- For v50.7-quality after the 2026-05-18 human-session review, low-information and gratitude inputs use deterministic short acknowledgements instead of Grok, risk-based safe-prefix streaming is disabled until real audible audit is reliable, and `potentialAudioLeak=0` is required for human-test readiness.
